...
export function Header({ onMenuClick, onSearchClick }: HeaderProps) {
  return (
    <header className="sticky top-9 md:top-10 z-40 bg-gradient-to-br from-[#0A1E3D] via-[#1E3A5F] to-[#0F2744] backdrop-blur-xl border-b border-blue-400/20 shadow-2xl shadow-blue-900/40 before:absolute before:inset-0 before:bg-gradient-to-r before:from-blue-600/10 before:via-transparent before:to-blue-600/10 before:animate-shimmer overflow-x-hidden">
      <div className="relative h-16 md:h-18 lg:h-18 px-3 md:px-6 lg:px-8 flex items-center justify-between gap-2 md:gap-3 lg:gap-4 max-w-[1920px] 2xl:max-w-full mx-auto w-full">
        ...
        >
          <Search className="h-4 w-4 md:h-5 md:w-5 lg:h-5 lg:w-5 text-blue-900/80 group-hover:text-blue-900 transition-colors duration-300" />
          <span className="hidden sm:block font-heading text-xs md:text-sm lg:text-sm font-semibold text-blue-900/80 group-hover:text-blue-900 tracking-tight transition-colors duration-300">
            Search
          </span>
        ...
        <Link href="/" className="flex-1 flex items-center justify-center gap-1 sm:gap-3 group min-w-0">
          ...
          <div className="hidden sm:block relative opacity-80 group-hover:opacity-100 transition-opacity duration-700">
            <Sparkles className="h-3 w-3 md:h-4 md:w-4 lg:h-4 lg:w-4 text-amber-400/70 animate-twinkle drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]" />
          </div>
          ...
          <div className="relative flex flex-col items-center min-w-0">
            ...
            <div className="relative flex items-baseline gap-1 sm:gap-1.5">
              <h1 className="font-[family-name:var(--font-playfair)] text-xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-transparent bg-gradient-to-br from-white via-blue-50 to-amber-50 bg-clip-text animate-elegant-fade tracking-tight whitespace-nowrap drop-shadow-[0_2px_10px_rgba(255,255,255,0.3)]">
                JOMO
              </h1>
            ...
            <div className="flex items-center gap-2 sm:gap-3 mt-0.5">
              <div className="h-px w-4 sm:w-6 md:w-10 lg:w-10 bg-gradient-to-r from-transparent via-amber-400/50 to-amber-300/30"></div>
              <span className="font-[family-name:var(--font-playfair)] text-[8px] sm:text-[10px] md:text-xs lg:text-xs text-amber-100/90 tracking-[0.3em] sm:tracking-[0.4em] uppercase italic font-light whitespace-nowrap drop-shadow-[0_1px_4px_rgba(251,191,36,0.3)]">
                World
              </span>
              <div className="h-px w-4 sm:w-6 md:w-10 lg:w-10 bg-gradient-to-r from-amber-300/30 via-amber-400/50 to-transparent"></div>
            </div>

            {/* Elegant Underline Animation */}
            <div className="absolute -bottom-2 md:-bottom-3 lg:-bottom-4 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-amber-400/0 to-transparent group-hover:via-amber-400/70 transition-all duration-1000 rounded-full shadow-[0_0_8px_rgba(251,191,36,0.5)]"></div>
          </div>

          {/* Elegant Sparkle Ornament - Hidden on mobile */}
          <div className="hidden sm:block relative opacity-80 group-hover:opacity-100 transition-opacity duration-700 delay-100">
            <Sparkles className="h-3 w-3 md:h-4 md:w-4 lg:h-4 lg:w-4 text-amber-400/70 animate-twinkle-delay drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]" />
          </div>
        </Link>
