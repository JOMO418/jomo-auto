      ...
      <div className="relative h-12 md:h-14 flex items-center justify-center px-3 md:px-6 w-full">
        ...
        >
          ...
          <div className="relative">
            ...
            <Phone className="relative h-4 w-4 md:h-5 md:w-5 text-amber-200 group-hover:text-amber-100 transition-colors duration-500 drop-shadow-[0_0_12px_rgba(251,191,36,0.8)]" />
          </div>

          {/* Small Text - "For Order/Inquiries" */}
          <span className="text-xs md:text-sm text-blue-100/90 group-hover:text-white font-normal tracking-wide transition-all duration-500">
            For Order/Inquiries
          </span>

          {/* Divider */}
          <div className="hidden sm:block h-5 w-px bg-blue-300/30 group-hover:bg-amber-400/40 transition-colors duration-500"></div>
          ...
          <div className="relative">
            ...
            <span className="relative font-heading text-lg md:text-2xl lg:text-3xl font-bold tracking-wide text-transparent bg-gradient-to-br from-white via-blue-50 to-amber-50 bg-clip-text drop-shadow-[0_2px_18px_rgba(255,255,255,0.9)] group-hover:from-amber-200 group-hover:via-white group-hover:to-amber-200 group-hover:drop-shadow-[0_3px_24px_rgba(251,191,36,1)] transition-all duration-700 animate-elegant-fade">
              {CONTACT_INFO.phone}
            </span>
